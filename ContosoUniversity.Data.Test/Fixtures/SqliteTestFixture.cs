...
namespace ContosoUniversity.Data.Test.Fixtures
{
    public class SqliteTestFixture : IDisposable
    {
        ...
        private DbContextOptions<SchoolContext> Options => new DbContextOptionsBuilder<SchoolContext>().UseSqlite(_connection).Options;
        public SchoolContext Context => CreateContext();
