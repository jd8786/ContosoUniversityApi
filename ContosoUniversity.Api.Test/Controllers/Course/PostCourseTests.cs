...
namespace ContosoUniversity.Api.Test.Controllers.Course
{
    ...
    public class PostCourseTests
    {
        ...
        [Fact]
        public void ShouldReturnOkResponseWhenPostingCourse()
        {
            _courseService.Setup(c => c.Add(It.IsAny<ApiModels.Course>())).Returns(new ApiModels.Course { CourseId = 1 });

            var response = _controller.PostCourse(new ApiModels.Course());
        ...
        {
            _courseService.Setup(c => c.Add(It.IsAny<ApiModels.Course>())).Throws(new InvalidCourseException("some-error-message"));

            var response = _controller.PostCourse(It.IsAny<ApiModels.Course>());
        ...
        {
            _courseService.Setup(c => c.Add(It.IsAny<ApiModels.Course>())).Throws(new NotFoundException("some-error-message"));
        ...
        {
            _courseService.Setup(c => c.Add(It.IsAny<ApiModels.Course>())).Throws(new Exception("some-error-message"));
