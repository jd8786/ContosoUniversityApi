...
namespace ContosoUniversity.Api.Test.Services
{
    ...
    public class StudentsServiceTests
    {
        ...
        public StudentsServiceTests()
        {
            ...
            _studentsService = new StudentsesService(_studentsRepository.Object, _enrollmentsRepository.Object,
                _studentValidator.Object, _mapper.Object);
        ...
        public void ShouldReturnUpdatedStudentWhenCallingUpdate()
        {
            ...
            existingStudent.Enrollments.Should().AllBeEquivalentTo(new List<Enrollment>());
